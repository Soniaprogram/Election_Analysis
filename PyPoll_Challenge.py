...
# Add a variable to save the file to a path. Modified to election_results.txt
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (countyvotes > largest_county_voter_turnout):
            largest_county_voter_turnout = countyvotes
